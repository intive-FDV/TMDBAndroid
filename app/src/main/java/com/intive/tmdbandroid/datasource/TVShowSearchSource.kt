...
class TVShowSearchSource(private val service: Service, private val query: String) : PagingSource<Int, ResultTVShowOrMovie>() {
    companion object {
        const val DEFAULT_PAGE_INDEX = 1
    }

    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, ResultTVShowOrMovie> {
        return try {
    ...
    override fun getRefreshKey(state: PagingState<Int, ResultTVShowOrMovie>): Int? {
