...
import com.intive.tmdbandroid.usecase.GetTVShowSimilarUseCase
...
class GetTVShowSimilarUseCaseTest {
    ...
    @Before
    fun setup(){
        getTVShowSimilarUseCase = GetTVShowSimilarUseCase(catalogRepository)
    }
    ...
    fun invokeTest() {
        mainCoroutineRule.runBlockingTest {
            BDDMockito.given(catalogRepository.getTVShowSimilar(anyInt())).willReturn(flowOf(screenings))

            val expected = getTVShowSimilarUseCase(2)
